...
public class TrainerShowAllUsersWithoutExercisesCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        ...
        String page = null;
        try {
            users = userService.findAllUsersWithoutExercises();
        } catch (ServiceException e) {
            logger.error(e);
            throw new CommandException(e);
        }
        request.setAttribute(AttributeName.USERS_WITHOUT_EXERCISES, users);
